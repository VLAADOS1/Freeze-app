...
🔗 [Пост от организаторов](ссылка_на_пост)
...
|:-----------:|:----------------:|
| ![Главная страница](screenshot/main-screen.jpg) | ![Суд Фризи](screenshot/verdikt.jpg) |

| Ожидание | AI Чат-Ассистент |
|:------------------:|:-----------------:|
| ![Ожидание](screenshot/await.jpg) | ![Чат](screenshot/aichat.jpg) |
